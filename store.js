// ═══════════════════════════════════════════════════════════════
//  SERVIDOR NODE.JS PARA EJECUTAR LA PÁGINA
// ═══════════════════════════════════════════════════════════════
...
if (typeof window === "undefined") {
  ...
  const PRODUCTS = {
    1: {
      ...
      artist: "Miles Davis",
      price: 89900,
      priceId: "price_1TMUdvCdA8vpL5CPTiApq4q8",
    },
    2: {
      name: "Rumours",
    ...
    try {
      ...
      if (IS_LOCALHOST) {
        ...
        try {
          ...
          throw new Error(
            "No se pudo contactar el servidor. ¿Está corriendo node server.js?",
          );
        }
